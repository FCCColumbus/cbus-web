...
describe("App", () => {
  test("renders App components in order", () => {
    ...
    const expected = `<div class="App">${mockHeader}${mockSplash}${mockAbout}${mockEvents}<img class="divider" src="/divider.jpg" alt="code on a screen. mostly css">${mockMembers}${mockFooter}</div>`;
